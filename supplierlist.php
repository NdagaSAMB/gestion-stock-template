...
<?php if (isset($_SESSION['admin'])): ?>
  ...
  if (isset($_GET['id_sup'])) {
    $id = $_GET['id_sup'];
    Supplier::supprimer($id);
  }
  $suppliers = Supplier::afficher();
  ?>
  <!DOCTYPE html>
  <html lang="fr">
      ...
      <div class="page-wrapper">
        <div class="content">
          <div class="page-header">
            ...
            <div class="page-btn">
              <a href="addsupplier.php" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" />Ajouter un fournisseur</a>
            </div>
          </div>
                      ...
                      <tr>
                        <td class="productimgname">
                          <a href="javascript:void(0);" class="product-img">
                            <img src="<?= $supplier['image'] ?>" alt="produit" />
                          </a>
