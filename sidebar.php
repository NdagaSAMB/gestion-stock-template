            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="addsupplierreturn.php" class="<?= $active[19] ?? ''; ?>">Supplier Return</a></li>
                        <li><a href="supplierreturnlist.php" class="<?= $active[20] ?? ''; ?>">Supplier Return List</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="stockmovements.php" class="<?= $active[17] ?? ''; ?>">Stock Movements</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="inventorylist.php" class="<?= $active[18] ?? ''; ?>">Inventory List</a></li>
                        <li><a href="addinventory.php" class="<?= $active[21] ?? ''; ?>">New Inventory Count</a></li>
                    </ul>
                </li>
